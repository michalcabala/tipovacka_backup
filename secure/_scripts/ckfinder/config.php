...
$config['licenseName'] = 'tm_secure';
$config['licenseKey']  = '*6?8-*1**-L**W-*M**-*8**-2*N*-3**E';
...
$config['privateDir'] = array(
    'backend' => 'default',
    'tags'   => 'files/.ckfinder/tags',
    'logs'   => 'files/.ckfinder/logs',
    'cache'  => 'files/.ckfinder/cache',
    'thumbs' => 'files/.ckfinder/cache/thumbs',
);
...
$config['backends'][] = array(
    'name'         => 'default',
    'adapter'      => 'local',
    'baseUrl'      => 'https://tipovacka.hcpcefans.cz/files/',
//  'root'         => '', // Can be used to explicitly set the CKFinder user files directory.
    'chmodFiles'   => 0777,
    'chmodFolders' => 0755,
    'filesystemEncoding' => 'UTF-8',
